...
# streamlit\mj_st.py  상대경로 복사
#(base) C:\Users\82102>cd C:\Users\82102\파이썬 프로그래밍\streamlit 이렇게 mini conda prompt에 적어서 경로 바꾼 후에 출력해야함

#(base) C:\Users\82102\파이썬 프로그래밍\streamlit>streamlit run mj_st.py 이 명령어로 출력
# 텍스트 출력
